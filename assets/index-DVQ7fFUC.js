...
`;function Y1(){return c.jsxs(G1,{children:[c.jsx(X1,{children:c.jsx(K1,{children:"歡迎來手機購物 & 手機租借網站"})}),c.jsx(kd,{children:"最新消息"}),c.jsx(Pd,{children:c.jsx(Q1,{})}),c.jsx(kd,{children:"熱賣商品"}),c.jsx(Pd,{children:c.jsx(V1,{})})]})}function q1(){const e="https://phone-web-db.onrender.com",[t,n]=E.useState([]),r=async()=>{try{const y=await(await fetch(`${e}/products`)).json();n(y)}catch(p){console.error("錯誤：",p)}};E.useEffect(()=>{r()},[]);const i=S.div`
  ...
  `,x=S.p`
    ...
    color: #e60000; /* ✅ 紅色價格 */
    margin-top: 5px;
  `;return c.jsxs(i,{children:[c.jsx(o,{children:" 手機商場"}),c.jsxs(l,{children:[c.jsx(a,{children:c.jsxs("ul",{children:[c.jsx("li",{children:c.jsx(s,{to:"/shopping/iphone",children:" Apple iPhone"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/ipad",children:" Apple iPad"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/samsung",children:" 三星系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/Xiaomi",children:" 小米系列"})})]})}),c.jsx(u,{children:t.map(p=>c.jsxs(h,{to:`/shopping/shopping-list/${p.id}`,children:[c.jsx(d,{src:p.image,alt:p.producsname}),c.jsx(g,{children:p.producsname}),c.jsxs(x,{children:["$",p.price]})]},p.id))})]})]})}function Z1(){const e="https://phone-web-db.onrender.com",t=async()=>{try{const y=await(await fetch(`${e}/lease`,{method:"get"})).json();r(y)}catch(p){console.log(p)}},[n,r]=E.useState([]);E.useEffect(()=>{t()},[]);const i=S.div`
   min-height: 100vh;
   background: linear-gradient(135deg, #f3f4f6, #d1d5db); /* ✅ 漸層背景 */
   padding: 20px;
 `,o=S.h1`
...
`,ww="https://phone-web-db.onrender.com",Sw=async()=>{try{const t=await(await fetch(`${ww}/products`,{method:"get"})).json();return console.log("API 回傳的 products:",t),t}catch(e){return console.error("Error fetching products:",e),[]}};function kw(){const[e,t]=E.useState([]),{productId:n}=Xp(),[r,i]=E.useState(!0);if(E.useEffect(()=>{(async()=>{console.log("開始取得產品資料..."),i(!0);const a=await Sw();t(a),i(!1)})()},[]),r)return c.jsx("p",{children:"載入中..."});console.log("所有產品:",e);const o=e.find(l=>l.id===n);return console.log("找到的產品:",o),o?c.jsxs(ow,{children:[c.jsxs(lw,{children:[c.jsx(aw,{children:c.jsx(sw,{src:o.image})}),c.jsxs(uw,{children:[c.jsx(cw,{children:o.producsname}),c.jsxs(dw,{children:["NT$",o.price]}),c.jsxs(fw,{children:[c.jsx(pw,{children:"直接購買"}),c.jsx(hw,{children:"加入購物車"})]})]})]}),c.jsxs(mw,{children:[c.jsx(gw,{children:"產品介紹"}),c.jsx(vw,{children:o.introduction})]}),c.jsx(yw,{children:c.jsx(xw,{to:"/shopping",children:"回商品頁"})})]}):c.jsx("p",{children:"產品未找到"})}function Pw(){const e="https://phone-web-db.onrender.com",t=async()=>{try{const y=await(await fetch(`${e}/products?_start=0&_end=11`,{method:"get"})).json();r(y)}catch(p){console.log(p)}},[n,r]=E.useState([]);E.useEffect(()=>{t()},[]);const i=S.div`
  ...
  `,x=S.p`
    ...
    color: #e60000; /* ✅ 紅色價格 */
    margin-top: 5px;
  `;return c.jsx(c.Fragment,{children:c.jsxs(i,{children:[c.jsx(o,{children:"手機商場"}),c.jsxs(l,{className:"shop",children:[c.jsx(a,{className:"shopleft",children:c.jsxs("ul",{children:[c.jsx("li",{children:c.jsx(s,{to:"/shopping/iphone",children:"apple iphone系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/ipad",children:"apple ipad系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/samsung",children:"三星系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/Xiaomi",children:"小米系列"})})]})}),c.jsx(u,{children:t.map(p=>c.jsxs(h,{to:`/shopping/shopping-list/${p.id}`,children:[c.jsx(d,{src:p.image,alt:p.producsname}),c.jsx(g,{children:p.producsname}),c.jsxs(x,{children:["$",p.price]})]},p.id))})]})]})})}function _w(){const e="https://phone-web-db.onrender.com",t=async()=>{try{const y=await(await fetch(`${e}/products?_start=17&_end=22`,{method:"get"})).json();r(y)}catch(p){console.log(p)}},[n,r]=E.useState([]);E.useEffect(()=>{t()},[]);const i=S.div`
  min-height: 100vh;
  background: linear-gradient(135deg, #f3f4f6, #d1d5db); /* ✅ 漸層背景 */
  padding: 20px;
`,o=S.h1`
...
`,x=S.p`
  ...
  color: #e60000; /* ✅ 紅色價格 */
  margin-top: 5px;
`;return c.jsx(c.Fragment,{children:c.jsxs(i,{children:[c.jsx(o,{children:"手機商場"}),c.jsxs(l,{className:"shop",children:[c.jsx(a,{className:"shopleft",children:c.jsxs("ul",{children:[c.jsx("li",{children:c.jsx(s,{to:"/shopping/iphone",children:"apple iphone系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/ipad",children:"apple ipad系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/samsung",children:"三星系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/Xiaomi",children:"小米系列"})})]})}),c.jsx(u,{children:n.map(p=>c.jsxs(h,{to:`/shopping/shopping-list/${p.id}`,children:[c.jsx(d,{src:p.image,alt:p.producsname}),c.jsx(g,{children:p.producsname}),c.jsxs(x,{children:["$",p.price]})]},p.id))})]})]})})}function Ew(){const e="https://phone-web-db.onrender.com",t=async()=>{try{const y=await(await fetch(`${e}/products?_start=23&_end=30`,{method:"get"})).json();r(y)}catch(p){console.log(p)}},[n,r]=E.useState([]);E.useEffect(()=>{t()},[]);const i=S.div`
  min-height: 100vh;
  background: linear-gradient(135deg, #f3f4f6, #d1d5db); /* ✅ 漸層背景 */
  padding: 20px;
`,o=S.h1`
...
`,x=S.p`
  ...
  color: #e60000; /* ✅ 紅色價格 */
  margin-top: 5px;
`;return c.jsx(c.Fragment,{children:c.jsxs(i,{children:[c.jsx(o,{children:"手機商場"}),c.jsxs(l,{className:"shop",children:[c.jsx(a,{className:"shopleft",children:c.jsxs("ul",{children:[c.jsx("li",{children:c.jsx(s,{to:"/shopping/iphone",children:"apple iphone系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/ipad",children:"apple ipad系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/samsung",children:"三星系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/shopping/Xiaomi",children:"小米系列"})})]})}),c.jsx(u,{children:n.map(p=>c.jsxs(h,{to:`/shopping/shopping-list/${p.id}`,children:[c.jsx(d,{src:p.image,alt:p.producsname}),c.jsx(g,{children:p.producsname}),c.jsxs(x,{children:["$",p.price]})]},p.id))})]})]})})}function Cw(){const e="https://phone-web-db.onrender.com",t=async()=>{try{const y=await(await fetch(`${e}/lease?_start=0&_end=11`,{method:"get"})).json();r(y)}catch(p){console.log(p)}},[n,r]=E.useState([]);E.useEffect(()=>{t()},[]);const i=S.div`
  min-height: 100vh;
  background: linear-gradient(135deg, #f3f4f6, #d1d5db); /* ✅ 漸層背景 */
  padding: 20px;
`,o=S.h1`
...
`,x=S.p`
  ...
  color: #e60000; /* ✅ 紅色價格 */
  margin-top: 5px;
`;return c.jsx(c.Fragment,{children:c.jsxs(i,{children:[c.jsx(o,{children:"手機租借"}),c.jsxs(l,{children:[c.jsx(a,{children:c.jsxs("ul",{children:[c.jsx("li",{children:c.jsx(s,{to:"/phonelease/iphone",children:"apple iphone系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/phonelease/ipad",children:"apple ipad系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/phonelease/samsung",children:"三星系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/phonelease/Xiaomi",children:"小米系列"})})]})}),c.jsx(u,{children:n.map(p=>c.jsxs(h,{to:`/phonelease/phonelease-list/${p.id}`,children:[c.jsx(d,{src:p.image,alt:p.producsname}),c.jsx(g,{children:p.producsname}),c.jsxs(x,{children:["$",p.price]})]},p.id))})]})]})})}function Ow(){const e="https://phone-web-db.onrender.com",t=async()=>{try{const y=await(await fetch(`${e}/lease?_start=12&_end=16`,{method:"get"})).json();r(y)}catch(p){console.log(p)}},[n,r]=E.useState([]);E.useEffect(()=>{t()},[]);const i=S.div`
   min-height: 100vh;
   background: linear-gradient(135deg, #f3f4f6, #d1d5db); /* ✅ 漸層背景 */
   padding: 20px;
 `,o=S.h1`
 ...
 `,x=S.p`
   ...
   color: #e60000; /* ✅ 紅色價格 */
   margin-top: 5px;
 `;return c.jsx(c.Fragment,{children:c.jsxs(i,{children:[c.jsx(o,{children:"手機租借"}),c.jsxs(l,{children:[c.jsx(a,{children:c.jsxs("ul",{children:[c.jsx("li",{children:c.jsx(s,{to:"/phonelease/iphone",children:"apple iphone系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/phonelease/ipad",children:"apple ipad系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/phonelease/samsung",children:"三星系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/phonelease/Xiaomi",children:"小米系列"})})]})}),c.jsx(u,{children:n.map(p=>c.jsxs(h,{to:`/phonelease/phonelease-list/${p.id}`,children:[c.jsx(d,{src:p.image,alt:p.producsname}),c.jsx(g,{children:p.producsname}),c.jsxs(x,{children:["$",p.price]})]},p.id))})]})]})})}function bw(){const e="https://phone-web-db.onrender.com",t=async()=>{try{const y=await(await fetch(`${e}/lease?_start=17&_end=22`,{method:"get"})).json();r(y)}catch(p){console.log(p)}},[n,r]=E.useState([]);E.useEffect(()=>{t()},[]);const i=S.div`
   min-height: 100vh;
   background: linear-gradient(135deg, #f3f4f6, #d1d5db); /* ✅ 漸層背景 */
   padding: 20px;
 `,o=S.h1`
 ...
 `,x=S.p`
   ...
   color: #e60000; /* ✅ 紅色價格 */
   margin-top: 5px;
 `;return c.jsx(c.Fragment,{children:c.jsxs(i,{children:[c.jsx(o,{children:"手機租借"}),c.jsxs(l,{children:[c.jsx(a,{children:c.jsxs("ul",{children:[c.jsx("li",{children:c.jsx(s,{to:"/phonelease/iphone",children:"apple iphone系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/phonelease/ipad",children:"apple ipad系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/phonelease/samsung",children:"三星系列"})}),c.jsx("li",{children:c.jsx(s,{to:"/phonelease/Xiaomi",children:"小米系列"})})]})}),c.jsx(u,{children:n.map(p=>c.jsxs(h,{to:`/phonelease/phonelease-list/${p.id}`,children:[c.jsx(d,{src:p.image,alt:p.producsname}),c.jsx(g,{children:p.producsname}),c.jsxs(x,{children:["$",p.price]})]},p.id))})]})]})})}function Tw(){const e="https://phone-web-db.onrender.com",t=async()=>{try{const y=await(await fetch(`${e}/lease?_start=23&_end=30`,{method:"get"})).json();r(y)}catch(p){console.log(p)}},[n,r]=E.useState([]);E.useEffect(()=>{t()},[]);const i=S.div`
  min-height: 100vh;
  background: linear-gradient(135deg, #f3f4f6, #d1d5db); /* ✅ 漸層背景 */
  padding: 20px;
`,o=S.h1`
